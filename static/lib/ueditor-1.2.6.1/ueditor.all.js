...
//                });
        ...
        getContent: function (cmd, fn,notSetCursor,ignoreBlank,formatter) {
            ...
            var html = root.toHtml(formatter);
            // add by robert
            if (me.options.onFormatContent) {
                html = me.options.onFormatContent(html);
            }
            //
            return html
        },
    ...
    Popup.prototype = {
        ...
        postRender: function (){
            ...
            if( this.captureWheel && !this.captured ) {
                ...
                //modified by robert: add _scrollTop
                var winHeight = ( document.documentElement.clientHeight || document.body.clientHeight )  - 30,
                ...
                while( _top - _scrollTop + _height > winHeight ) {
                    _height -= 30;
    ...
    EditorUI.prototype = {
        ...
        initEditorUI:function () {
            ...
            function setCount(editor,ui) {
                ...
                if (count > max) {
                    countDom.innerHTML = errMsg.replace("{#overflow}", count - max);
                    editor.fireEvent("wordcountoverflow");
                } else {
                    countDom.innerHTML = msg.replace("{#leave}", max - count).replace("{#count}", count);
                    //add by robert
                    editor.fireEvent("wordcountnormal");
                }
            }
